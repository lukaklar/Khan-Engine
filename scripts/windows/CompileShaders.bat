...
%~dp0..\..\extern\VulkanSDK\Windows\Bin\dxc.exe -spirv -fvk-invert-y -T vs_6_0 -E VS_Test ..\..\source\graphics\shaders\test.hlsl -Fo ..\..\bin\shaders\vulkan\test_VS.spv
%~dp0..\..\extern\VulkanSDK\Windows\Bin\dxc.exe -spirv -T ps_6_0 -E PS_Test ..\..\source\graphics\shaders\test.hlsl -Fo ..\..\bin\shaders\vulkan\test_PS.spv

%~dp0..\..\extern\VulkanSDK\Windows\Bin\dxc.exe -spirv -fvk-invert-y -T vs_6_0 -E VS_Common -fvk-t-shift 4 1 ..\..\source\graphics\shaders\gbuffercommon.hlsl -Fo ..\..\bin\shaders\vulkan\common_VS.spv
