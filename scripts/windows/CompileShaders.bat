...
%~dp0..\..\extern\VulkanSDK\Windows\Bin\dxc.exe -spirv -T vs_6_0 -E VS_Common -fvk-t-shift 4 1 ..\..\source\graphics\shaders\gbuffercommon.hlsl -Fo ..\..\bin\shaders\vulkan\common_VS.spv
...
%~dp0..\..\extern\VulkanSDK\Windows\Bin\dxc.exe -spirv -T vs_6_0 -E VS_Main -fvk-b-shift 0 0 -fvk-t-shift 4 0 -fvk-u-shift 12 0 ..\..\source\graphics\shaders\depth.hlsl -Fo ..\..\bin\shaders\vulkan\depth_VS.spv
